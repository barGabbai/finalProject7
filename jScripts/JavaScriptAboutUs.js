...
$(document).ready(function () {
    ...
    var topOfWhoWeAreDiv = $("#whoAreWePage").offset().top - 450;
    var topOfNumbersDiv = $("#numbersPage").offset().top - 450;
    var topOfSayingDiv = $("#sayingPage").offset().top - 450;
    var topOfContactDiv = $("#contactPage").offset().top-750;
