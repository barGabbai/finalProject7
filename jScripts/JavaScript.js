$(document).ready(function () {
    ...
    $('#videoCareer').hide();
    $('#dykCareer').hide();
    $('#assistanceCareer').hide();

    $('#videoFriendship').hide();
    $('#dykFriendship').hide();
    $('#assistanceFriendship').hide();

    $('#videoFamily').hide();
    $('#dykFamily').hide();
    $('#assistanceFamily').hide();
    ...
    $('#friendshipLink').click(function () {
        ...
        $('#videoFriendship').show();
        $('#dykFriendship').show();
        $('#assistanceFriendship').show();
    });
    ...
    $('#aboutUsLink').click(function () {
        ...
        $('#sayingPage').show();
        $('#contactPage').show();
        $('#contactContainer2').show();
        $('#contactContainer').show();

    });

    $('.contactShowInnerPages').click(function () {
        if ($(window).width() > 765) {
            $('#contactContainer2').show();
            $('#contactContainer').show();
    ...
    $('#questionnaireLink').on('click', function () {
        $('#forMeSection').hide();
        $('#q1').show();
