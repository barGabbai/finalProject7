$(document).ready(function () {
    ...
    $('#carouselExampleControls').on('slid.bs.carousel', function () {
        ...
        if (currentIndex == 1) {
            ...
            $(".siteInto").find("#qInstQ").html("מתוך הקטגוריות הבאות, לחץ על הקטגוריה החשובה ביותר עבורך.");
        ...
        if (currentIndex == 2) {
            ...
            $(".siteInto").find("#qInstQ").html("סמן את <b>מצבך הנוכחי</b> בכל אחד מהתחומים הבאים:");
